...
const Card: React.FC<CardProps> = ({
  ...
  return (
    <div
      className={`flex flex-col rounded overflow-hidden shadow-lg text-texts ${getSizeClass()}`}
    ...
    >
      ...
      {about || description ? (
        <div className="px-6 pt-4 pb-4">
          <div style={getAboutStyle()} className="font-bold text-xl mb-2">
            {about}
          </div>
          <p style={getDescriptionStyle()} className="text-base">
            {description}
          </p>
        </div>
      ) : (
